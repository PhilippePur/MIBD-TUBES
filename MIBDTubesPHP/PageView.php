...
// Masukkan data view ke tabel Tonton
...
// Ambil jumlah view
$sqlViews = "SELECT COUNT(*) AS jumlahView FROM Tonton WHERE idVideo = ?";
...
<body>
    ...
    <div data-layer="PageView" class="Pageview"
        ...
        <div data-layer="Rectangle 12" class="Rectangle12"
            style="width: 1430px; height: 294px; left: 33px; top: 976px; position: absolute; background: #D9D9D9; border-radius: 42px">
        </div>
        <div data-layer="Rectangle 13" class="Rectangle13"
            style="width: 1430px; height: 662px; left: 33px; top: 1292px; position: absolute; background: #D9D9D9; border-radius: 42px">
        </div>
        <div data-layer="Frame 2" class="Frame2"
            ...
            <div data-svg-wrapper data-layer="SideBorder" class="Sideborder">
                <svg width="1512" height="144" viewBox="0 0 1512 144" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div data-layer="SureName" class="Surename"
            style="width: 98px; height: 27px; left: 137px; top: 1474px; position: absolute; justify-content: center; display: flex; flex-direction: column; color: black; font-size: 15px; font-family: Roboto; font-weight: 700; line-height: 16px; letter-spacing: 0.40px; word-wrap: break-word">
            SureName</div>
        <div data-layer="User1" class="User1"
            style="width: 98px; height: 27px; left: 137px; top: 1701px; position: absolute; justify-content: center; display: flex; flex-direction: column; color: black; font-size: 15px; font-family: Roboto; font-weight: 700; line-height: 16px; letter-spacing: 0.40px; word-wrap: break-word">
            User1</div>
        <div data-layer="6 Bulan Yang lalu" class="BulanYangLalu"
            style="width: 179px; height: 27px; left: 222px; top: 1475px; position: absolute; justify-content: center; display: flex; flex-direction: column; color: black; font-size: 12px; font-family: Roboto; font-weight: 400; line-height: 16px; letter-spacing: 0.40px; word-wrap: break-word">
            6 Bulan Yang lalu</div>
        <div data-layer="6 Tahun Yang lalu" class="TahunYangLalu"
            style="width: 179px; height: 27px; left: 191px; top: 1701px; position: absolute; justify-content: center; display: flex; flex-direction: column; color: black; font-size: 12px; font-family: Roboto; font-weight: 400; line-height: 16px; letter-spacing: 0.40px; word-wrap: break-word">
            6 Tahun Yang lalu</div>
        <div data-layer="Diunggah 8 Tahun yang lalu" class="Diunggah8TahunYangLalu"
        ...
        <div data-layer="Komentar" class="Komentar"
            style="width: 336px; height: 44px; left: 65px; top: 1314px; position: absolute; justify-content: center; display: flex; flex-direction: column; color: black; font-size: 24px; font-family: Roboto; font-weight: 700; line-height: 16px; letter-spacing: 0.40px; word-wrap: break-word">
            Komentar</div>
        ...
        <div data-layer="Tambahkan Komentar" class="TambahkanKomentar"
            style="width: 239.88px; height: 43.66px; left: 137px; top: 1372px; position: absolute; justify-content: center; display: flex; flex-direction: column; color: black; font-size: 16px; font-family: Roboto; font-weight: 400; line-height: 16px; letter-spacing: 0.40px; word-wrap: break-word">
            Tambahkan Komentar</div>
        <div data-layer="Deskripsi"
            style="width: 1325px; height: 345px; left: 68px; top: 1055px; position: absolute; color: black; font-size: 16px; font-family: Roboto; font-weight: 400; line-height: 16px; letter-spacing: 0.40px; word-wrap: break-word">
        ...
        <div data-layer="Lorem ipsum dolor sit amet, consectetur adipiscing elit. In commodo massa sed tempus porta. Aenean quis nibh sem. Phasellus sodales odio vitae felis finibus porta. Mauris vel ante vitae dolor dapibus varius. Ut imperdiet egestas molestie. Duis ullamcorper faucibus lacus, elementum placerat massa lacinia in. Praesent sed placerat diam. Etiam aliquet nibh id posuere imperdiet. Donec vel imperdiet orci. Etiam sit amet tellus placerat, lobortis nunc quis, pulvinar metus. Proin imperdiet eros ut lacus tempor vehicula. Morbi sagittis convallis quam vel aliquam. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In et aliquam diam. Duis faucibus neque a magna ullamcorper, id faucibus nulla commodo. Proin posuere ante neque, aliquet fringilla quam fermentum at. In dictum, tellus dapibus viverra cursus, odio massa tincidunt lorem, a ultricies ligula tellus eget urna. Cras molestie fringilla libero, id volutpat metus convallis vel. Proin id risus arcu. Phasellus pharetra eu quam quis facilisis. Proin dignissim non diam vel vestibulum. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Proin eget ultrices ipsum, non molestie enim. Nulla feugiat enim eu mattis rutrum. Sed aliquam odio et nibh auctor, a vehicula mauris cursus. Aliquam id magna commodo, condimentum elit mollis, vulputate neque."
            ...
            style="width: 1257px; height: 195px; left: 136px; top: 1509px; position: absolute; color: black; font-size: 16px; font-family: Roboto; font-weight: 400; line-height: 16px; letter-spacing: 0.40px; word-wrap: break-word">
        ...
        <div data-layer="Lorem ipsum dolor sit amet, consectetur adipiscing elit. In commodo massa sed tempus porta. Aenean quis nibh sem. Phasellus sodales odio vitae felis finibus porta. Mauris vel ante vitae dolor dapibus varius. Ut imperdiet egestas molestie. Duis ullamcorper faucibus lacus, elementum placerat massa lacinia in. Praesent sed placerat diam. Etiam aliquet nibh id posuere imperdiet. Donec vel imperdiet orci. Etiam sit amet tellus placerat, lobortis nunc quis, pulvinar metus. Proin imperdiet eros ut lacus tempor vehicula. Morbi sagittis convallis quam vel aliquam. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In et aliquam diam. Duis faucibus neque a magna ullamcorper, id faucibus nulla commodo. Proin posuere ante neque, aliquet fringilla quam fermentum at. In dictum, tellus dapibus viverra cursus, odio massa tincidunt lorem, a ultricies ligula tellus eget urna. Cras molestie fringilla libero, id volutpat metus convallis vel. Proin id risus arcu. Phasellus pharetra eu quam quis facilisis. Proin dignissim non diam vel vestibulum. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Proin eget ultrices ipsum, non molestie enim. Nulla feugiat enim eu mattis rutrum. Sed aliquam odio et nibh auctor, a vehicula mauris cursus. Aliquam id magna commodo, condimentum elit mollis, vulputate neque."
            class=""
            style="width: 1257px; height: 195px; left: 136px; top: 1729px; position: absolute; color: black; font-size: 16px; font-family: Roboto; font-weight: 400; line-height: 16px; letter-spacing: 0.40px; word-wrap: break-word">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In commodo massa sed tempus porta. Aenean quis nibh
            sem. Phasellus sodales odio vitae felis finibus porta. Mauris vel ante vitae dolor dapibus varius. Ut
            imperdiet egestas molestie. Duis ullamcorper faucibus lacus, elementum placerat massa lacinia in. Praesent
            sed placerat diam. Etiam aliquet nibh id posuere imperdiet. Donec vel imperdiet orci. Etiam sit amet tellus
        ...
        <div data-layer="Uploader" class="Uploader" style="left: 48px; top: 884px; position: absolute;">
            <img class="User1-Image" src="<?= htmlspecialchars($video['fotoProfil']) ?>" alt="Foto Channel"
                style="width: 59px; height: 59px; border-radius: 50%;">
        </div>
        <div data-layer="User1-Wrapper" class="User1-Wrapper" style="left: 87px; top: 1709px; position: absolute;">
            <img data-layer="User1" class="User1-Image" src="Assets/User1.png" alt="Foto User 1"
        ...
        <a href="homePage.php" data-layer="Youtube-Logo" class="YoutubeLogo"
            ...
            <div data-svg-wrapper data-layer="Vector" class="Vector"
                style="left: 18.41px; top: 9.14px; position: absolute">
                <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.407425 13.8566L12.3657 7.00064L0.407425 0.144531V13.8566Z" fill="white" />
                </svg>
            </div>
            <div data-svg-wrapper data-layer="Vector" class="Vector"
                style="left: 50.58px; top: 2.27px; position: absolute">
            ...
            <div data-svg-wrapper data-layer="Vector" class="Vector"
                style="left: 64.29px; top: 9.27px; position: absolute">
            ...
            <div data-svg-wrapper data-layer="Vector" class="Vector"
                style="left: 79.23px; top: 9.66px; position: absolute">
                <svg width="13" height="22" viewBox="0 0 13 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div data-svg-wrapper data-layer="Vector" class="Vector"
                style="left: 90.41px; top: 2.27px; position: absolute">
        ...
        <div data-layer="Rectangle 6" class="Rectangle6"
            style="width: 179px; height: 48px; left: 261px; top: 895px; position: absolute; background: #D9D9D9; border-radius: 139px">
        </div>
        ...
        <div id="likeBtn" onclick="likeDislike(1)" data-layer="Like Button" class="Like Button"
            ...
            <div data-svg-wrapper data-layer="liked-fill" class="LikedFill"
                style="left: 10; top: 0; position: absolute">
            ...
            <div id="likeCount" style="width: 115px; height: 44px; position: absolute; left: 25; top: 3;
                color: black; font-size: 16px; font-family: Roboto; font-weight: 400;
                line-height: 44px; text-align: center; letter-spacing: 0.40px;">
                <?= htmlspecialchars($jumlahLike) ?>
            </div>
        </div>


        <div data-layer="SUBSCRIBED" class="Subscribed"
            style="width: 148px; height: 44px; left: 277px; top: 897px; position: absolute; text-align: center; justify-content: center; display: flex; flex-direction: column; color: white; font-size: 20px; font-family: Roboto; font-weight: 400; line-height: 16px; letter-spacing: 0.40px; word-wrap: break-word">
            SUBSCRIBED</div>
        <div id="dislikeBtn" onclick="likeDislike(2)" class="Tombol Dislike"
            ...
            <div data-svg-wrapper data-layer="liked-fill" class="LikedFill"
                style="left: 10; top: 7; position: absolute">
                <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div id="dislikeCount" style="width: 115px; height: 44px; position: absolute; left: 25; top: 3;
                color: black; font-size: 16px; font-family: Roboto; font-weight: 400;
                line-height: 44px; text-align: center; letter-spacing: 0.40px;">
        ...
        <div data-layer="MainProfile-Wrapper" class="MainProfile-Wrapper"
            style="left: 87px; top: 1376px; position: absolute;">
            <img data-layer="MainProfile" class="MainProfile-Image" src="Assets/MainProfile.jpg" alt="Foto User 1"
                style="width: 40px; height: 40px; border-radius: 50%;">
        </div>


        <div data-layer="MainProfile-Wrapper" class="MainProfile-Wrapper"
            style="left: 87px; top: 1482px; position: absolute;">
            <img data-layer="MainProfile" class="MainProfile-Image" src="Assets/MainProfile.jpg" alt="Foto User 1"
                style="width: 40px; height: 40px; border-radius: 50%;">
        </div>

        <div data-layer="Line 1" class="Line1"
            style="width: 1256px; height: 0px; left: 137px; top: 1416px; position: absolute; outline: 1px black solid; outline-offset: -0.50px">
        </div>
    </div>
    <script>
        function likeDislike(action) {
            console.log("Tombol diklik. Action =", action);
            ...
            fetch('like_dislike.php', {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        document.getElementById('dislikeCount').innerText = data.dislikes + ' Dislike';
                    } else {
                        alert('Gagal memperbarui like/dislike');
                    }
                })
                .catch(error => {
